#' @description Calculating the systematic error (average BIAS) of the list of thetas hat and true by the item (1 - 35)
...
biasOfItem <- function(thHatList, thTrueList, item) {
