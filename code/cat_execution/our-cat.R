...
hitFirst3Items = function(itemsList) {
  return (length(itemsList) >= 3 && itemsList[[1]] && itemsList[[2]] && itemsList[[3]])
}
...
write.table(BIAS, file=paste("outs/5k_examinees/implemented_cat/2012/local/fixed_stop_rule/bias-our-cat.out", sep=""))
write(RMSE, file=paste("outs/5k_examinees/implemented_cat/2012/local/fixed_stop_rule/rmse-our-cat.json", sep=""))
