...
write.table(rangeByitemsMean, file=paste("outs/5k_examinees/implementing_cat_algorithm/2012/by_spenassato_params/statistics-by-true-theta-700k.out", sep=""), row.names=FALSE, col.names=TRUE)