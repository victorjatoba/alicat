...
#' @param data The statistics
#' @param g_range the length theta range
plotBias = function(g_range, mfiResult, klResult, klpResult, mlwiResult, mpwiResult) {
  # 1 ITEM
...
#' @param data The statistics
#' @param g_range the length theta range
plotRmse = function(g_range, mfiResult, klResult, klpResult, mlwiResult, mpwiResult) {
  # 1 ITEM
...
plotBias(g_range, as.data.frame(mfiResult), as.data.frame(klResult), as.data.frame(klpResult), as.data.frame(mlwiResult), as.data.frame(mpwiResult))
#plotRmse(g_range, as.data.frame(mfiResult), as.data.frame(klResult), as.data.frame(klpResult), as.data.frame(mlwiResult), as.data.frame(mpwiResult))
