...
mfiResult  <- getRangeByItemsMean("MFI", initValue, stopValue, step)[,1]
klResult   <- getRangeByItemsMean("KL", initValue, stopValue, step)[,1]
klpResult  <- getRangeByItemsMean("KLP", initValue, stopValue, step)[,1]
mpwiResult <- getRangeByItemsMean("MPWI", initValue, stopValue, step)[,1]
gdiResult <- getRangeByItemsMean("GDI", initValue, stopValue, step)[,1]
gdipResult <- getRangeByItemsMean("GDIP", initValue, stopValue, step)[,1]
...
# the actual plots 
legend('bottomleft',g_range[2], c("MFI","KL", "KLP", "MPWI", "GDI", "GDIP"), cex=0.6, 
       col=c("blue", "green", "darkgreen", "purple", "red", "orange"), pch=21:22, lty=1:2)
